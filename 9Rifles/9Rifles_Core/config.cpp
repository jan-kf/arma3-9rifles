...
//         texture = "9Rifles_Core\UI\custom_patch_co.paa"; // Image path
...
class CfgUnitInsignia {
    class UK_9Rifles_Patch {
        displayName = "9 Rifles"; 
        author = "Yoshi";
        texture = "9Rifles_Core\Data\Patches\uk9riflesPatch.paa"; 
        textureVehicle = ""; // Leave empty
    };
	class UK_4Commando_big4_Patch {
        displayName = "4 Commando [Big 4]"; 
        author = "Yoshi";
        texture = "9Rifles_Core\Data\Patches\uk4commandoBig4Patch.paa"; 
        textureVehicle = ""; // Leave empty
    };
	class UK_4Commando_fullName_Patch {
        displayName = "4 Commando [name]"; 
        author = "Yoshi";
        texture = "9Rifles_Core\Data\Patches\uk4commandoNamePatch.paa"; 
        textureVehicle = ""; // Leave empty
    };
};
...
{   
	...
	//this setObjectTexture [9, "9Rifles_Core\Data\Vehicles\man_con_9_jeff_desert_dark.paa"];
    ...
    //     hiddenSelectionsTextures[] = {"9Rifles_Core\Data\uk_nato.paa"};
    //     // hiddenSelectionsMaterials[] = {"9Rifles_Core\Data\custom_camo.rvmat"};  
    ...
    class BarrisonPrime_MH6: B_Heli_Light_01_F
    {
        ...
        hiddenSelectionsTextures[] = {"9Rifles_Core\Data\Vehicles\barrisonprime_heli_mh6.paa"};
	...
	class B_UGV_9RIFLES_F: B_UGV_01_F
	{
		...
		{
			"9Rifles_Core\Data\Vehicles\stompy_ext.paa",
			"9Rifles_Core\Data\Vehicles\stompy_int.paa",
    ...
    class Flag_UK_9Rifles_F: FlagCarrier
    {
		...
		editorPreview="9Rifles_Core\Data\Flags\Flag_9rifles_F.jpg"; // Correct use, copy this for future ref
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture '9Rifles_Core\Data\Flags\flag_9rifles_co.paa'";
		};
    };
    ...
    class Banner_01_9Rifles_F: Banner_01_base_F
	{
		...
		editorPreview="9Rifles_Core\Data\Flags\Banner_01_9Rifles_F.jpg"; 
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\flag_9rifles_co.paa"
		};
	};
	class Banner_01_9Rifles_Falcon_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\banner_falcon.paa"
		};
	};
	class Banner_01_9Rifles_Copper_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\banner_copper.paa"
		};
	};
	class Banner_01_9Rifles_Campbeltown_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\banner_campbeltown.paa"
		};
	};
	class Banner_01_9Rifles_Team_1_1_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_1-1.paa"
		};
	};
	class Banner_01_9Rifles_Team_1_2_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_1-2.paa"
		};
	};
	class Banner_01_9Rifles_Team_1_3_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_1-3.paa"
		};
	};
	class Banner_01_9Rifles_Team_2_1_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_2-1.paa"
		};
	};
	class Banner_01_9Rifles_Team_2_2_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_2-2.paa"
		};
	};
	class Banner_01_9Rifles_Team_2_3_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_2-3.paa"
		};
	};
	class Banner_01_9Rifles_Team_Logistics_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_logistics.paa"
		};
	};
	class Banner_01_9Rifles_Team_FireSupport_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_fireSupport.paa"
		};
	};
	class Banner_01_9Rifles_Team_AssaultPioneers_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_assaultPioneers.paa"
		};
	};
	class Banner_01_9Rifles_Team_AAC_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_AAC.paa"
		};
	};
	class Banner_01_9Rifles_Team_PltCommand_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_pltCommand.paa"
		};
	};
	class Banner_01_9Rifles_Team_CompanyHQ_F: Banner_01_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Flags\team_companyHQ.paa"
		};
	};
    ...
    class Land_PaperBox_01_small_closed_barrisonprime_F: Land_PaperBox_01_small_closed_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"9Rifles_Core\Data\Supplies\barrisonPrime_box.paa" 
		};
	};
    ...
    class Box_9Rifles_Medical_F: ReammoBox_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"9Rifles_Core\Data\Supplies\medical_text.paa" // Text
		};
		class DestructionEffects
		{
			class HouseDestr
    ...
    class Box_9Rifles_Ammo_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\ammo_text.paa" // Text
		};
    };
    class Box_9Rifles_Trash_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\trash_text.paa" // Text
		};
    };
    class Box_9Rifles_Supplies_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\supplies_text.paa" // Text
		};
    };
    class Box_9Rifles_Food_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\food_text.paa" // Text
		};
    };
    class Box_9Rifles_Equipment_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\equipment_text.paa" // Text
		};
    };
	class Box_9Rifles_AmmoMag_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\ammo_magazines.paa" // Text
		};
    };
	class Box_9Rifles_AmmoBeltShells_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\ammo_beltsShells.paa" // Text
		};
    };
	class Box_9Rifles_AmmoSupport_F: Box_9Rifles_Medical_F
    {
		...
		{
			"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
			"9Rifles_Core\Data\Supplies\ammo_support.paa" // Text
		};
    };
	...
	// 	{
	// 		"\A3\Supplies_F_Exp\Ammoboxes\Data\uniforms_box_blufor_co.paa", // Texture
	// 		"9Rifles_Core\Data\Supplies\textTest.paa" // Text
	// 	};
    // };
};
...
{ 
    ...
    //     hiddenSelectionsTextures[] = {"9Rifles_Core\Data\uk_plates.paa"}; 
    ...
    //     hiddenSelections[] = {"Camo"};
    //     hiddenSelectionsTextures[] = {"9Rifles_Core\Data\rainbow_beret.paa"};
